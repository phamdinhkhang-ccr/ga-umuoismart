...
const DEFAULT_CMS_SETTINGS: Record<string, string> = {
  ...
  CMS_FOOTER_JSON: JSON.stringify({
  ...
  CMS_FOOTER_BRAND: 'GÀ Ủ MUỐI SMART',
  CMS_FOOTER_ADDRESS: '6 - A20 Geleximco An Khánh - Tây Mỗ, Hoài Đức / Nam Từ Liêm, Hà Nội',
  CMS_FOOTER_HOTLINE: '0396637038',
  CMS_FOOTER_EMAIL: 'cskh@gaumuoismart.vn',
  CMS_FOOTER_HOURS: 'Thứ 2 - Chủ Nhật: 08:00 - 22:00',
  STORE_NAME: 'GÀ Ủ MUỐI SMART',
  STORE_ADDRESS: '6 - A20 Geleximco An Khánh - Tây Mỗ, Hoài Đức / Nam Từ Liêm, Hà Nội',
  STORE_HOTLINE: '0396637038',
